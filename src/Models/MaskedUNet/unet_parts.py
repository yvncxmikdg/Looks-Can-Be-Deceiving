...
class Attention_block(nn.Module):
    def __init__(self, F_g, F_l, F_int, kernel_size=1):
        ...
        self.W_g = nn.Sequential(
            ...
            nn.GroupNorm(F_int, F_int) #TODO: Parameterize normalization strategy for backwards compatibility
            )
        ...
        self.psi = nn.Sequential(
            ...
            nn.GroupNorm(1, 1), #TODO: Parameterize normalization strategy for backwards compatibility
            nn.Sigmoid()
        )
...
class DoubleConv(nn.Module):
    def __init__(self, in_channels, out_channels, mid_channels=None, dilation=1, kernel_size=5, padding_mode='zeros'):
        ...
        self.double_conv = nn.Sequential(
            ...
            nn.GroupNorm(mid_channels, mid_channels), #TODO: Parameterize normalization strategy for backwards compatibility
            nn.GELU(),
            ...
            nn.GroupNorm(out_channels, out_channels), #TODO: Parameterize normalization strategy for backwards compatibility
            nn.GELU()
        )
